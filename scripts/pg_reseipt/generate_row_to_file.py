...
with open(OUTPUT_FILE, 'w', newline='') as csvfile:
    fieldnames = ['user_id', 'account_id', 'year', 'month', 'week_of_year', 'operation_id', 'type', 'amount', 'description', 'full_timestamp']
    ...
    print("2% of users with a minimum value of 10 and a maximum of 100:")
