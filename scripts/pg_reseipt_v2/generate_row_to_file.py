...
print(f"COPY pgs_receipt_v2.bills_10000 (user_id, account_id, year, month, dt_uuid, week_of_year, operation_id, type, amount, description, full_timestamp) FROM '{OUTPUT_FILE}' WITH DELIMITER=',' AND HEADER=TRUE;")
